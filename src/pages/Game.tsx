...
// Level components — lazy loaded für kleineres Initial-Bundle.
// Jeder Level wird erst beim Betreten geladen.
const Level01 = lazy(() => import('../components/levels/Level01'))
const Level02 = lazy(() => import('../components/levels/Level02'))
const LevelHintergrund = lazy(() => import('../components/levels/LevelHintergrund'))
const Level03 = lazy(() => import('../components/levels/Level03'))
const LevelBestrahlung = lazy(() => import('../components/levels/LevelBestrahlung'))
const Level04 = lazy(() => import('../components/levels/Level04'))
const Level05 = lazy(() => import('../components/levels/Level05'))
const Level06 = lazy(() => import('../components/levels/Level06'))
const LevelNuklidkarte = lazy(() => import('../components/levels/LevelNuklidkarte'))
const LevelNuklearmedizin = lazy(() => import('../components/levels/LevelNuklearmedizin'))
const Level07 = lazy(() => import('../components/levels/Level07'))
const Level08 = lazy(() => import('../components/levels/Level08'))
const LevelC14 = lazy(() => import('../components/levels/LevelC14'))
const Level09 = lazy(() => import('../components/levels/Level09'))
const LevelStrahlenkrankheit = lazy(() => import('../components/levels/LevelStrahlenkrankheit'))
const Level10 = lazy(() => import('../components/levels/Level10'))
const Level11 = lazy(() => import('../components/levels/Level11'))
const LevelKernspaltung = lazy(() => import('../components/levels/LevelKernspaltung'))
const LevelAtomkraftwerk = lazy(() => import('../components/levels/LevelAtomkraftwerk'))
const Level12 = lazy(() => import('../components/levels/Level12'))
const Endscreen = lazy(() => import('../components/levels/Endscreen'))

// Generischer Lade-Fallback während ein Level chunk nachgeladen wird
const LevelLoader = () => (
  <div className="flex items-center justify-center h-full text-cyan-400 text-sm tracking-widest">
    SEKTOR WIRD GELADEN…
  </div>
)
...
export default function Game() {
  ...
  if (state.currentLevel >= 20) {
    return <>{notifOverlay}<Suspense fallback={<LevelLoader />}><Endscreen state={state} /></Suspense></>
  }
